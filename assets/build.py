...
# ------------------------------------------------------------- identity ----
# All personal details live here so nothing else in the file needs touching.
NAME = "Rishi"
HANDLE = "guest@rishi:~"       # terminal prompt label
HERO_TEXT = "Hello, I'm Rishi"
HERO_CAPTION = "full stack developer"
GITHUB_USER = "Rishu-s08"
LEETCODE_USER = "rishu-s08"    # change to your real LeetCode username
...
def build_hero():
    ...
    return (
        svg_open(HERO_W, HERO_H, "%s — %s" % (TYPED, CAPTION))
        ...
        + '<text x="%.1f" y="%.1f" text-anchor="middle" fill="%s" font-family="%s" '
          'font-size="12" letter-spacing="1">%s</text>'
          % (px + pw / 2, py + 21, MUTED, FONT, HANDLE)
...
# ------------------------------------------------------------------ about ---
# Commands type out; their output prints at once.
SESSION = [
    ("cmd", "whoami"),
    ("gap", None),
    ("out", "I'm a full stack developer who loves building web and mobile apps."),
    ("out", "I'm currently learning new technologies and always eager to build cool things."),
    ("out", "I'm looking to collaborate on open-source projects and side projects."),
    ("out", "Ask me about anything — if I don't know, I'll learn and answer."),
    ("out", "Fun fact: I want to learn everything!"),
]
...
def fetch_leetcode(user=LEETCODE_USER):
